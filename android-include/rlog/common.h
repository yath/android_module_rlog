...
// #define RLOG_TIME_TSC @HAVE_TSC@ <-- XXX is this used anywhere? might be USE_RDTSC..
...
#define HAVE_GCC_DATA_SECTION_ATTRIBUTE 0
#define HAVE_GCC_SIMPLE_SECTION_ATTRIBUTE 1
